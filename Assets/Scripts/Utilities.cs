...
{
	// This coroutine takes a list of GameObjects and modifies their opacity
	// (from 1.0 to 0.3 and then to 1.0) using a constant time delay. This is
	// to animate the potential matches that are given as a hint to the user.
	...
	// This method tries to find and return a list of possible matches for the game
	// to animate, as a hint to the user. It loops in all glyphs, calls six different
	// methods that search for potential matches, and gathers their results.
	// If we search half the array and we have less than equal or two matches, we
	// return a return one.
	public static IEnumerable<GameObject> GetPotentialMatches(ShapesArray shapes)
	{
		...
		for (int row = 0; row < Constants.Rows; row++)
		{
			for (int column = 0; column < Constants.Columns; column++)
			{
				...
				// If in the middle of the calculations/loops and we have less than
				// 3 matches, return a random one
